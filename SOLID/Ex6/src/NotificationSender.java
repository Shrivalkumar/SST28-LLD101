public abstract class NotificationSender {
    ...
    public final void send(Notification n){
        if ((n.phone == null || !n.phone.startsWith("+")) &&requiresPlusInPhone()) {
        ...
        giveNotification(n, finalBody);
    }
    public abstract void giveNotification(Notification n , String finalBody);
